...
マリンスノーを画面内の視覚要素として採用する。現在はSpriteの表示経路を確認するため、移動や個体差を外した最小構成とする。チューブの動きには追従させない。
...
- マリンスノー: 5,000枚の単色インスタンス化Sprite、OrbitControlsの注視点を中心とする16m × 10m × 20mの範囲、確認用サイズ0.08m、色`#b9d8df`。移動、サイズ差、透明度、円形加工は一時的に無効
- DPR上限: 2
