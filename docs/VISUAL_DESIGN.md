...
マリンスノーを画面内の視覚要素として採用する。初期実装では5,000点をGPU上で沈降、漂流、循環させる。チューブの動きには追従させない。
...
- マリンスノー: 5,000点、範囲16m × 10m × 20m、沈降速度0.025m/秒、漂流速度係数0.18、漂流幅0.08m、点サイズ0.022、色`#b9d8df`、不透明度0.56
- DPR上限: 2
